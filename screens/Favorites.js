...
//   // ✅ Reverse user favorites to show newly added first
//   const userFavoritesReversed = [...favorites].reverse();

//   // ✅ Merge default + user favorites without duplicates
//   const combinedQuotes = [
//     ...userFavoritesReversed,
//     ...defaultFavorites.filter(
//       def => !favorites.some(fav => fav.quote === def.quote)
//     )
//   ];
